...
import "./globals.css";
import { Registry as StyledComponentRegistry } from "@/style/registy";
...
next 에서는
서버 렌더링 구성 요소가 html에서 스트리밍 되기 때문에 공급자와 컨텍스트가 서버 렌더링 구성요소에서 직접적으로
사용되는 것을 허용하지 않는다.
...
방식을 next가 가지고 있다. (서버의 부담은 감소, 사용자 경험은 증가되는 효과)
